...
double GeocentricConverter::degToRad(double degrees) const
{
    return degrees * M_PI / 180.0;
}

double GeocentricConverter::radToDeg(double radians) const
{
    return radians * 180.0 / M_PI;
}

Geocentric GeocentricConverter::toGeocentric(const Geodetic &geodetic) const
{
...
Geodetic GeocentricConverter::fromGeocentric(const Geocentric &geocentric) const
{
